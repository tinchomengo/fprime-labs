module TelemetryDeployment {
  ...
  # ----------------------------------------------------------------------
    ...
    # include "TelemetryDeploymentPackets.fppi"
  ...
  # ----------------------------------------------------------------------
    ...
    connections RateGroups {
      ...
      rateGroup1.RateGroupMemberOut[5] -> detumbleSim.run
      rateGroup1.RateGroupMemberOut[6] -> orbitPropagator.run

      # Rate group 2
      rateGroupDriver.CycleOut[Ports_RateGroups.rateGroup2] -> rateGroup2.CycleIn
      rateGroup2.RateGroupMemberOut[0] -> cmdSeq.schedIn
      # Was never wired by the bootstrap template - without this,
      # cmdDisp.run_handler() (which is what actually calls
      # tlmWrite_CommandsDispatched/CommandErrors/CommandsDropped) never
      # runs, so those channels never publish at all, regardless of how
      # many commands are dispatched.
      rateGroup2.RateGroupMemberOut[1] -> CdhCore.cmdDisp.run
    ...
    connections TelemetryDeployment {
