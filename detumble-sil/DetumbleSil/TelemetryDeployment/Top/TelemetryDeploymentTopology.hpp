...
#include <DetumbleSil/TelemetryDeployment/Top/TelemetryDeploymentTopologyDefs.hpp>
 ...
 *
 * For an explanation of the required type TelemetryDeployment::TopologyState see: TelemetryDeploymentTopologyDefs.hpp.
 *
