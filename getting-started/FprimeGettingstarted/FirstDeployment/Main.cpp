...
#include <FprimeGettingstarted/FirstDeployment/Top/FirstDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
static void signalHandler(int signum) {
    FprimeGettingstarted::stopRateGroups();
}
...
int main(int argc, char* argv[]) {
    ...
    FprimeGettingstarted::TopologyState inputs;
    ...
    FprimeGettingstarted::setupTopology(inputs);
    FprimeGettingstarted::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    FprimeGettingstarted::teardownTopology(inputs);
