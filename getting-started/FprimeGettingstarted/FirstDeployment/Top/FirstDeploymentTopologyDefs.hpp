...
#include "FprimeGettingstarted/FirstDeployment/Top/FppConstantsAc.hpp"
 ...
 */
namespace PingEntries {
    namespace FprimeGettingstarted_rateGroup1 {enum { WARN = 3, FATAL = 5 };}
    namespace FprimeGettingstarted_rateGroup2 {enum { WARN = 3, FATAL = 5 };}
    namespace FprimeGettingstarted_rateGroup3 {enum { WARN = 3, FATAL = 5 };}
    namespace FprimeGettingstarted_cmdSeq {enum { WARN = 3, FATAL = 5 };}
}  // namespace PingEntries
 ...
 *
 * The topology autocoder requires an object that carries state with the name `FprimeGettingstarted::TopologyState`. Only the type
