...
#include <FprimeGettingstarted/FirstDeployment/Top/FirstDeploymentTopologyDefs.hpp>
 ...
 *
 * For an explanation of the required type FprimeGettingstarted::TopologyState see: FprimeGettingstartedTopologyDefs.hpp.
 *
