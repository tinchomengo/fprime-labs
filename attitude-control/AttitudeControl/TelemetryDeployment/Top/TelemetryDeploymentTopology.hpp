// ======================================================================
// \title  TelemetryDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef TELEMETRYDEPLOYMENT_TELEMETRYDEPLOYMENTTOPOLOGY_HPP
...
#include <AttitudeControl/TelemetryDeployment/Top/TelemetryDeploymentTopologyDefs.hpp>
 ...
 * TelemetryDeployment::TopologyState see: TelemetryDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type AttitudeControl::TopologyState see: AttitudeControlTopologyDefs.hpp.
 *
