...
#include <AttitudeControl/TelemetryDeployment/Top/TelemetryDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
static void signalHandler(int signum) {
    AttitudeControl::stopRateGroups();
}
...
int main(int argc, char* argv[]) {
    ...
    AttitudeControl::TopologyState inputs;
    ...
    AttitudeControl::setupTopology(inputs);
    AttitudeControl::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    AttitudeControl::teardownTopology(inputs);
